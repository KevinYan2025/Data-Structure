...
public class BSTStudentTest {
    ...
    public void testAdd() {
        ...
        */
        ...
        assertEquals((Integer) 5, tree.getRoot().getRight().getRight().getData());
        assertEquals((Integer) 4, tree.getRoot().getRight().getRight().getLeft().getData());
    ...
    public void testGet() {
        ...
        */
        ...
        assertSame(temp185, tree.getRoot().getLeft().getData());
        assertSame(temp190, tree.getRoot().getLeft().getRight().getData());
        assertSame(temp195, tree.getRoot().getLeft().getRight().getRight().getData());
...
//    @Test(timeout = TIMEOUT)
//    public void testfindDCA(){
//
//        tree.add(1);
//        tree.add(0);
//        tree.add(2);
//        tree.add(3);
//        BSTNode<Integer> data = new BSTNode<>(0);
//        data = tree.findDCA(tree.getRoot(), 0, 3);
//        assertSame(1, data.getData());
//    }
...
//
        ...
        expected.add(37);
        expected.add(40);
        assertEquals(expected, tree.findPathBetween(10, 40));

        expected.clear();
        expected.add(75);
        assertEquals(expected, tree.findPathBetween(75, 75));

        expected.clear();
        expected.add(50);
        expected.add(25);
        expected.add(37);
        assertEquals(expected, tree.findPathBetween(50, 37));

        expected.clear();
        expected.add(50);
        expected.add(75);
        assertEquals(expected, tree.findPathBetween(50, 75));
        expected.clear();
        expected.add(37);
        expected.add(40);
        assertEquals(expected, tree.findPathBetween(37, 40));

        assertThrows(NoSuchElementException.class, () -> {
            tree.findPathBetween(327, 40);
        });

        assertThrows(NoSuchElementException.class, () -> {
            tree.findPathBetween(327, 402);
        });

        assertThrows(NoSuchElementException.class, () -> {
            tree.findPathBetween(37, 402);
        });
    }
}
