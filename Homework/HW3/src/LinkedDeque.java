...
public class LinkedDeque<T> {
    ...
    public void addFirst(T data) {
        ...
        if (size == 0) {
            ...
            LinkedNode<T> node = new LinkedNode<>(data, null, head);
    ...
    public void addLast(T data) {
        ...
        if (size == 0) {
            ...
            LinkedNode<T> node = new LinkedNode<>(data, tail, null);
            tail.setNext(node);
            tail = node;
        }
        size++;
    ...
    public T getFirst() {
        if (size == 0) {
            throw new NoSuchElementException("Cannot retrieve element from a empty deque!");
        }
        return head.getData();
    }
